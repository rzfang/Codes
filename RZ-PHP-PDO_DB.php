...
class Db
{
  /* class info.
    ...
    Author: RZ Fang.
    Last Version Date: 20130319. */

//==== Class Property ==================================================================================================

  // default database object.
  private static $Db0 = null; // '$Db0' = default Database object with PDO format.
...
//==== Class Method ====================================================================================================
  ...
  public static function Connect($Host, $DBNm, $Usr, $Pswd)
  {
    $CntInfo = 'mysql:host=' . $Host . ';dbname=' . $DBNm . ';';
    $Db = null;
  ...
  public static function RandomGet($Tbl, $Nbr = 1, $Db = null)
  {
    ...
    try
    {
      $Rsc = $Db->query("SELECT * FROM $Tbl ORDER BY RAND() LIMIT $Nbr;");
    }
    catch(PDOException $Ex)
    {
      echo 'Connection failed: ' . $Ex->getMessage();
...
//==== Project Case Function ===========================================================================================
  ...
  {
    if (!defined('DB_HOST') || !defined('DB_NM') || !defined('DB_USR') || !defined('DB_PSWD'))
      return -1;

    self::$Db0 = self::Connect(DB_HOST, DB_NM, DB_USR, DB_PSWD);
  ...
  /* Close default Db.
    Return: 0 always. */
  public static function Db0Close()
  {
    self::$Db0 = null;
